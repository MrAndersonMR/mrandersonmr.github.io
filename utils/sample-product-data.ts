...
export const sampleProductData: Product[] = [
  {
    ...
    categories: [],
    labels: [
      "bi|BiSolidWasher|easyClean|easyClean",
      "bi|BiSolidCalendarCheck|durable|durable",
      "io5|IoShirtSharp|light|light",
    ],
    colors: ["black"],
    sizes: ["xs", "s", "m", "l"],
    features: [],
  ...
  },
  {
    ...
    description: "",
    categories: [],
    labels: ["gi|GiCottonFlower|cotton|100Cotton"],
    colors: ["white"],
    sizes: ["xs", "s", "m", "l", "lx"],
    features: [],
    faqs: [],
  ...
  },
  {
    ...
    categories: [],
    labels: [
      "si|SiStylelint|manyDesigns|manyDesigns",
      "gi|GiRolledCloth|comfortable|comfortable",
    ],
    colors: ["black"],
    sizes: ["s", "m", "l", "lx"],
    features: [
  ...
  },
  {
    ...
    categories: [],
    labels: [
      "ai|AiOutlineGlobal|imported|imported",
      "gi|GiShirtButton|collection|collection",
    ],
    colors: ["yellow", "lime"],
    sizes: ["m", "l", "lx"],
    features: [],
  ...
  },
  {
    ...
    description: "",
    categories: [],
    labels: ["ai|AiOutlineGlobal|imported|imported"],
    colors: [],
    sizes: [],
    features: [],
    faqs: [],
  ...
  },
  {
    ...
    categories: [],
    labels: [
      "gi|GiFlatPlatform|lowCalories|lowCalories",
      "gi|GiFlatPlatform|localProducer|localProducer",
    ],
    colors: [],
    sizes: [],
    features: [],
